...
\par Introdução sobre a plataforma Arduino aqui. Mencionar rapidamente a plataforma, alguns projetos, o fato que utiliza C, o bloqueio dos drivers fornecendo um exemplo (SPI pode se provar ser o mais fácil por ser claro o polling).
\par Microcontroladores Arduino são normalmente programados em um ambiente de linguagem C, uma linguagem procedural.
